...
<head>
  ...
  <link rel="shorcut icon" type="image/x-icon" href="./web/images/icon.png">
  <!--Bootstrap 4-->
  ...
  <link rel="stylesheet" href="./web/css/style404notFound.css">
</head>

<body>
  <header class="bg-dark pt-4">
    <div class="d-flex justify-content-between flex-wrap align-items-center">
      <a href=""><img class="logo row ml-5 mb-3" src="./web/images/logo.png" alt="Logotipo"></a>
